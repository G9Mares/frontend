...
| `LandingPageComponent` | `src/app/features/auth/landing-page` | Support User sign-in through the real authentication contract; Requester entry remains provisional | Partially integrated |
