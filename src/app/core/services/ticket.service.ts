    ...
    [
      {
        ...
        requester: { id: 'mock-requester-1', name: 'Alex Requester', email: 'alex@example.com', phone: '+1 555 0101' },
        area: { id: 'mock-area-technical-support', name: 'Technical Support' },
      ...
      },
      {
        ...
        requester: { id: 'mock-requester-2', name: 'Morgan Requester', email: 'morgan@example.com', phone: '+1 555 0102' },
        area: { id: 'mock-area-account-services', name: 'Account Services' },
